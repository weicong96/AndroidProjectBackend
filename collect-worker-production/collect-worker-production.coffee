                    ...
                    if !error and response.statusCode is 200 
                        ...
                        parseJSON = (response, _datasource, parse)=>
                            ...
                            if currentData["cod"] is "404"
                                console.log "No city"
                                return deferred.resolve {timeCollected: new Date(), key : _datasource.key ,data : "No city error", id : _datasource, formulaid : formulaid , park : _park}
        ...
        for status in result.statuses 
            for pattern in status.patterns
                if @fetchedPatternsDataset.indexOf(pattern["dataset"]["_id"]) == -1 
                    console.log @fetchedPatternsDataset
                    console.log pattern["dataset"]
                                                                    ...
                                                                    @Models.Data.insert results,(err,data)=>
                                                                        if !err
                                                                           jobData = 
                                                                            ...
                                                                            @bsPutJob "data_change", JSON.stringify jobData
                    ...
                    console.log "Already have dataset"
    setupFormula : ()=>
        secondsPassed = 0
